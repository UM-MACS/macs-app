...
//                        break;
                    case R.id.navigation_forum:
                        if(CurrentUser.getInstance().getUserType().equalsIgnoreCase("Specialist")
                            ...
                            Intent i6 = new Intent(SearchForumActivity.this, CaregiverForumActivity.class);
                            startActivity(i6);
                            break;
                        } else {
                    ...
                    case R.id.navigation_chat:
                        Intent i7 = new Intent(SearchForumActivity.this, ChatChannelListActivity.class);
                        startActivity(i7);
                        break;
                }
                return true;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_faq) {
            Intent intent = new Intent(SearchForumActivity.this, OnboardingBaseActivity.class);
            startActivity(intent);
            return true;
        }
