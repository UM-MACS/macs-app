...
public class SpecialistViewForumFavouriteActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_specialist_view_forum_favourite);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                switch (menuItem.getItemId()) {
                    case R.id.navigation_emotion_assessment:
                        Intent i2 = new Intent(SpecialistViewForumFavouriteActivity.this, EmotionAssessmentActivity.class);
                        startActivity(i2);
                        break;
                    case R.id.navigation_exercise:
                        Intent i3 = new Intent(SpecialistViewForumFavouriteActivity.this, ExerciseDashboardActivity.class);
                        startActivity(i3);
                        break;
...
//                        break;
                    case R.id.navigation_forum:
                        if(CurrentUser.getInstance().getUserType().equalsIgnoreCase("Specialist")
                            ...
                            Intent i6 = new Intent(SpecialistViewForumFavouriteActivity.this, CaregiverForumActivity.class);
                            startActivity(i6);
                            break;
                        } else {
                            Intent i6 = new Intent(SpecialistViewForumFavouriteActivity.this, ForumActivity.class);
                            startActivity(i6);
                            break;
                        }
                    case R.id.navigation_chat:
                        Intent i7 = new Intent(SpecialistViewForumFavouriteActivity.this, ChatChannelListActivity.class);
                        startActivity(i7);
                        break;
                }
                return true;
    ...
    public void onNavFavouritePatientForum(View v){
        Intent i = new Intent(SpecialistViewForumFavouriteActivity.this, ViewForumFavouriteListActivity.class);
        startActivity(i);
    }

    public void onNavFavouriteCaregiverForum(View v){
        Intent i = new Intent(SpecialistViewForumFavouriteActivity.this, CaregiverViewForumFavouriteListActivity.class);
        startActivity(i);
    }
...
//            finish();
        ...
        if (id == R.id.action_change_password){
            Intent intent = new Intent(SpecialistViewForumFavouriteActivity.this, ChangePasswordActivity.class);
            startActivity(intent);
            return true;
        }

        if(id == R.id.action_user_profile){
            Intent intent = new Intent(SpecialistViewForumFavouriteActivity.this, UserProfileActivity.class);
            startActivity(intent);
            return true;
        }

        if (id == R.id.action_faq) {
            Intent intent = new Intent(SpecialistViewForumFavouriteActivity.this, OnboardingBaseActivity.class);
            startActivity(intent);
            return true;
        }
