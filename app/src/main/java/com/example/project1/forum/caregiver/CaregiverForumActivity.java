            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                switch (menuItem.getItemId()) {
                    ...
                    case R.id.navigation_chat:
                        Intent i7 = new Intent(CaregiverForumActivity.this, ChatChannelListActivity.class);
                        startActivity(i7);
                        break;
                }
                return true;
...
//                                Log.e("TAG", "pic: " + picture);
    ...
    public void onExpand(View v){
        ...
        if(!getPostPhotoString.equals("")){
            ...
            postImage.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent fullScreenIntent = new Intent(CaregiverForumActivity.this, FullScreenPostImageActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_faq) {
            Intent intent = new Intent(CaregiverForumActivity.this, OnboardingBaseActivity.class);
            startActivity(intent);
            return true;
        }

        if(id == R.id.action_questionnaire){
            Intent intent = new Intent(CaregiverForumActivity.this, QuestionnaireActivity.class);
            startActivity(intent);
            return true;
        }
