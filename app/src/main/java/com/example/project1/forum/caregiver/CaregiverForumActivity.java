            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                switch (menuItem.getItemId()) {
                    ...
                    case R.id.navigation_schedule_appointment:
                        Intent i3 = new Intent(CaregiverForumActivity.this, EventReminderActivity.class);
                        startActivity(i3);
                        break;
                    case R.id.nagivation_event_assessment:
                        Intent i4 = new Intent(CaregiverForumActivity.this, SelfAssessmentListActivity.class);
                        startActivity(i4);
                        break;
//                    case R.id.navigation_faq:
//                        Intent i5 = new Intent(CaregiverForumActivity.this, FAQActivity.class);
//                        startActivity(i5);
//                        break;
