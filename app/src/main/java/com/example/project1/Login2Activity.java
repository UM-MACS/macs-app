            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                switch (menuItem.getItemId()){
                    case R.id.navigation_home:
                        Intent i1 = new Intent(Login2Activity.this,MainActivity.class);
                        startActivity(i1);
                        break;
                    case R.id.navigation_emotion_tracking:
                        Intent i2 = new Intent(Login2Activity.this,emotionActivity.class);
                        startActivity(i2);
                        break;
                    case R.id.navigation_schedule_appointment:
                        Intent i3 = new Intent(Login2Activity.this,scheduleActivity.class);
                        startActivity(i3);
                        break;
                }
                return true;
...
//                        Intent myIntent = new Intent(Login2Activity.this, emotionActivity.class);
